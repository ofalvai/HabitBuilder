...
class HabitEntityTest {
    ...
    fun insertAndReadHabits() = testCoroutineScope.runBlockingTest {
        val newHabit1 = Habit(name = "New habit")
        val newHabit2 = Habit(name = "Other new habit")
    ...
    fun insertAndReadActions() = testCoroutineScope.runBlockingTest {
        val habitId = 51
        val habit = Habit(id = habitId, name = "Meditation")
    ...
    fun readActionsByHabit() = testCoroutineScope.runBlockingTest {
        val habitId = 875
        val habit1 = Habit(id = habitId, name = "Meditation")
        val habit2 = Habit(name = "Drinking enough water")
        val habit3 = Habit(name = "Workout")
